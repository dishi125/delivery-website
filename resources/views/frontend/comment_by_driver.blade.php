            ...
            <div class="modal-dialog1 response-modal  md1" role="document" style="">
                <div class="modal-content container">
                    <div class="modal-header" style="display: inline">
                        <center><h1 style="color: black;">Rate Your Customer</h1></center>
                    </div>
                    <div class="modal-body">
                        <div class="form" id="user-form">

                            <form method="post" role="form" id="ReviewForm" action="{{url('driver_submit_review')}}">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row set-center">
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" style="display: flex;justify-content: center;">
                                            <input type="submit" class="form-control footer-button color-white" value="Submit">
                                        </div>
                                    </div>
                                    <div class="row set-center">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex;justify-content: center;">
                                            <a class="form-control back-button" href="{{url('/assign_request')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i>Not Now</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
