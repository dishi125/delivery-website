                ...
                <div class="modal-content container-fluid">
                    <section>
                        ...
                        <div class="scrolling-wrapper">
                            <div style="" class="space_top_modal_mobile">
                                <div class="col-sm">
                                    <div class="row fromloc pkg-div">
                                        <div class="index-div col-lg-8">
                                            <div class="request-i"><a href="javascript:void(0)"
                                                                      class="text-center index-button show_hide packageloc"><i
                                                        id="fafa" class="fa fa-plus faplus" aria-hidden="true"></i> From Location A</a></div>
                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control" id="country1" name="country1">
                                                            ...
                                                            @foreach($country as $cnt)
                                                                <option value="{{$cnt->id}}"
                                                                        @if($fromdata->country_id==$cnt->id) selected @endif>{{$cnt->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <?php
                                                    $name=\App\Models\Country::where('id',$fromdata->country_id)->pluck('name')->first();
...
//                                                    $cities=\App\Models\City::where('country_name',$name)->pluck('name');
                                                    ...
                                                    <div class="form-group">
                                                        <select name="province1" id="province1" class="form-control">
                                                            ...
                                                            @foreach($provinces as $province)
                                                                <option value="{{$province}}" @if($fromdata->province==$province) selected @endif>{{ $province }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <?php
                                                    $cities=\App\Models\City::where('province_name',$fromdata->province)->pluck('name');
                                                    ?>
                                                    <div class="form-group">
                                                        {{--<select name="city1" id="city1" class="form-control">
                                                            <option value="" style="color: #6C757D">City</option>
                                                            @foreach($cities as $city)
                                                                <option value="{{$city}}" @if($fromdata->city==$city) selected @endif>{{ $city }}</option>
                                                            @endforeach
                                                        </select>--}}
                                                        <input type="text" class="form-control" name="city1" id="city1" placeholder="City" value="{{ $fromdata->city }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="postalcode1" id="postalcode1" placeholder="Postal Code" value="{{ $fromdata->postalcode }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control uniqueadd"
                                                               name="toaddress" id="toaddress"
                                                               placeholder="Street Address"
                                                               onkeypress="handleEnterKey(event)"
                                                               value="{{$fromdata->street_add}}"/>
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12"
                                                            ...
                                                            <div class="row">
                                                                <div
                                                                    class="col-md-12 col-sm-8 col-lg-7 col-xs-8 padding-right-0-1024">
                                                                    <input type="text" class="form-control input-number"
                                                                           name="sms1"
                                                                           id="sms1" style="width: 100%"
                                                                           placeholder="SMS Verification"
                                                                           value="{{$fromdata->sms_verification}}"/>

                                                                    <div class="validation"></div>
                                                                </div>
                                                                <div
                                                                    class="col-md-12 col-sm-4 col-lg-5 col-xs-4 padding-0"
                                                                    style="padding: 0px">
                                                                    <input type="button" name="sendotp"
                                                                           class="btn send-verification "
                                                                           value="Verify OTP"
                                                                           style="background-color: #FFC56C;color: white;width: 100%; display: none "
                                                                           disabled/>
                                                                    <br>
                                                                    <span class="verify-otp" style="color: red"></span>

                                                                    {{-- <input type="text" name="otp"
                                                                            class="otp-field-main"
                                                                            value="{{$fromdata->sms_verification}}"
                                                                            style="display: none">--}}
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="index-div col-lg-8  signchange">
                                            <div class="request-i"><a href="javascript:void(0)"
                                                                      class="text-center index-button package uniqpackage"><i
                                                        class="fa fa-plus faplus packageplus" aria-hidden="true"></i> Package 1</a></div>
                                        </div>
                                        <div class="form uniqfrompackage package-data"
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-set  col-6">
                                                        <div class="form-group">
                                                            <input type="text" name="weight" class="form-control allow_decimal"
                                                                   ...
                                                                   required placeholder="Weight" value="{{$pkgfirst->weight}}"/>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control package-control package-weight" name="packagekg">
                                                                @foreach($packagekg as $key=>$value)
                                                                    <option value="{{$value}}" @if($pkgfirst->packagekg==$value) selected @endif>{{$key}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-set col-6 ">
                                                        <div class="form-group">
                                                            <input type="text" name="dimesionl"
                                                                   ...
                                                                   value="{{$pkgfirst->dimesionl}}"/>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-set col-6">
                                                        <div class="form-group">
                                                            <input type="text" name="dimesionw"
                                                                   class="form-control package-control package-weight allow_decimal"
                                                                   id="dimesionw" placeholder="W"
                                                                   value="{{$pkgfirst->dimesionw}}"/>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-set col-6">
                                                        <div class="form-group">
                                                            <input type="text" name="dimesionh"
                                                                   ...
                                                                   value="{{$pkgfirst->dimesionh}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-set col-6">
                                                        <div class="form-group">
                                                            <?php $dimension = \App\Enums\Dimensions::asArray();?>
                                                            <select class="form-control package-control package-weight"
                                                                    name="dimensions">
                                                                @foreach($dimension as $key=>$value)
                                                                    <option value="{{$value}}"
                                                                            @if($pkgfirst->dimesions==$value) selected @endif>{{$key}}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group uniqlocation">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <select
                                                                class="form-control package-control package-weight location"
                                                                required name="location">
                                                                <option value="">Location</option>
                                                                <option value="{{$pkgfirst->location}}"
                                                                        selected>{{$pkgfirst->location1}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6 full-1024">
                                                        <div class="form-group">
                                                            <input type="text" required name="date"
                                                                   ...
                                                                   value="{{$pkgfirst->newdate}}"/>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mobile-top-margin full-1024">
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            @if($pkgfirst->image==null)
                                                                <img class="package-img" style="display:none;"/>
                                                                <input type="hidden" value="" name="hiddenimg">
                                                            @else
                                                                <img class="package-img" src="{{$pkgfirst->Path}}"/>
                                                                <input type="hidden" value="{{$pkgfirst->image}}"
                                                                       name="hiddenimg">
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="add-div add-package col-lg-8">
                                            <div class="request-i"><a href="javascript:void(0)"
                                                                      class="text-center index-button"
                                                                      style="color: black;background-color: white;"><i
                                                        class="fa fa-plus faplus" aria-hidden="true"></i> Add
                                                    Package</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="row pkg-div">
                                        <div class="index-div col-lg-8">
                                            <div class="request-i"><a href="javascript:void(0)"
                                                                      class="text-center index-button to-show_hide packageloc"><i
                                                        class="fa fa-plus faplus" aria-hidden="true"></i> To Location B</a>
                                            </div>
                                        </div>
                                        <div class="tocontent dest-to" style="display: none">
                                            <div class="heading">
                                                <h4 style="color: black;">Delivery Address <span style="color: black;"
                                                                                                 id="initialto"></span>
                                                </h4>
                                            </div>
                                            <div class="form">
                                                <form method="post" role="form" class="MyformTo" id="MyformTo0">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="name" class="form-control name"
                                                               placeholder="Your Name" value="{{$todata->name}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="company" class="form-control "
                                                               id="company" placeholder="Company Name"
                                                               value="{{$todata->company_id}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <select class="form-control country" name="country">
                                                            ...
                                                            @foreach($country as $cnt)
                                                                <option value="{{$cnt->id}}"
                                                                        @if($todata->country_id==$cnt->id) selected @endif>{{$cnt->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <?php
                                                    $name=\App\Models\Country::where('id',$todata->country_id)->pluck('name')->first();
                                                    $provinces=\App\Models\Province::where('country_name',$name)->pluck('name');
//                                                    $cities=\App\Models\City::where('country_name',$name)->pluck('name');
                                                    ?>
                                                    <div class="form-group">
                                                        <select name="province" id="province" class="form-control">
                                                            <option value="" style="color: #6C757D">Province/Territory/State</option>
                                                            @foreach($provinces as $province)
                                                                <option value="{{$province}}" @if($todata->province==$province) selected @endif>{{ $province }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <?php
                                                    $cities=\App\Models\City::where('province_name',$todata->province)->pluck('name');
                                                    ?>
                                                    <div class="form-group">
                                                        {{--<select name="city" id="city" class="form-control">
                                                            <option value="" style="color: #6C757D">City</option>
                                                            @foreach($cities as $city)
                                                                <option value="{{$city}}" @if($todata->city==$city) selected @endif>{{ $city }}</option>
                                                            @endforeach
                                                        </select>--}}
                                                        <input type="text" class="form-control" name="city" id="city" placeholder="City" value="{{ $todata->city }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="postalcode" id="postalcode" placeholder="Postal Code" value="{{ $todata->postalcode }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control address uniqueadd"
                                                               name="address" id="address" placeholder="Street Address"
                                                               onkeypress="handleEnterKey(event)"
                                                               value="{{$todata->street_add}}"/>
                                                        <input type="hidden" class="lat" name="lat"
                                                               value="{{$todata->lat}}">
                                                        <input type="hidden" class="long" name="long"
                                                               value="{{$todata->long}}">
                                                       {{-- <div class="suggesstion-box" hidden="hidden">
                                                        ...
                                                        <label id="address-error" class="error none-display"
                                                               for="address"></label>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control address1" name="address1"
                                                               placeholder="Apt, Floor, Suite, etc.(Optional)"
                                                               value="{{$todata->street_add1}}"/>
                                                    </div>

                                                    <div class="form-group">
                                                        <input type="text" pattern="[1-9]{1}[0-9]{9}"
                                                               name="mobile_number" id="mobile_number"
                                                               class="form-control phone mobile_number input-number"
                                                               placeholder="Phone" style="margin-bottom: 0"
                                                               value="{{$todata->mobile}}"/>
                                                        <p style="display: inline;  position: absolute;margin-top: 5px;">
                                                            Ext.</p>
                                                        <input type="tel" id="mobile_number1" name="mobile_number1"
                                                               class="form-control phone1 mobile_number1 inter_tel"
                                                               placeholder="(Optional)" value="{{$todata->mobile1}}"
                                                               disabled="disabled">
                                                        <label id="mobile_number-error" class="error num_er"
                                                               for="mobile_number" hidden="hidden"></label>
                                                        {{--<input type="text" pattern="[1-9]{1}[0-9]{9}" name="mobile1" class="form-control phone1" placeholder="(Optional)">--}}
                                                    </div>

                                                    <div class="form-group">
                                                        <input type="email" class="form-control email" name="email"
                                                               placeholder="Email" value="{{$todata->email}}"/>
                                                    </div>
                                                    {{--                                                    <div class="form-group">--}}
                                                    {{--                                                        <input type="text" class="form-control sms" name="sms"--}}
                                                    {{--                                                               placeholder="SMS Verification"--}}
                                                    {{--                                                               value="{{$todata->sms_verification}}"/>--}}
                                                    {{--                                                    </div>--}}
                                                    {{--                                                    <input type="submit" style="display: none;">--}}
                                                </form>
                                            </div>
                                ...
                                @foreach($allloc as $key => $loc1)
                                    ...
                                    $tos = chr(++$loc);
                                    $intelid = "ext" . ++$cnt_ext;
                                    $addid = "address" . ++$cnt_autoadd;
                                    ?>
                                    <div class="col-sm toloc" id="{{++$cnt}}">
                                        <div class="row">
                                            <div class="index-div col-lg-8">
                                                <div class="request-i"><a href="javascript:void(0)"
                                                                          class="text-center index-button location-button packageloc"><i
                                                            class="fa fa-plus faplus fa-dest-add"
                                                            aria-hidden="true"></i> To Location <?php echo $tos; ?><i
                                                            class="fa fa-close loc-close loc1-close"
                                                            aria-hidden="true"></i></a></div>
                                            </div>
                                            <div style="display: none" class="add_destination dest-to">
                                                <div class="heading">
                                                    <h4 style="color: black;">Delivery Address <span
                                                            style="color: black;" id="initialto"></span></h4>
                                                </div>
                                                <div class="form">
                                                    <form method="post" role="form" class="MyformTo MyFormReset"
                                                          id="MyformTo{{++$formcnt}}">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="formname"
                                                               value="MyformTo{{$formcnt}}">
                                                        <div class="form-group">
                                                            <input type="text" name="name" class="form-control name"
                                                                   placeholder="Your Name" value="{{$loc1->name}}"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="company" class="form-control"
                                                                   placeholder="Company Name"
                                                                   value="{{$loc1->company_id}}"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <select class="form-control country" name="country">
                                                                <option value="" style="color: #6C757D">Country</option>
                                                                @foreach($country as $cnt1)
                                                                    <option value="{{$cnt1->id}}"
                                                                            @if($loc1->country_id == $cnt1->id) selected @endif>{{$cnt1->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <?php
...
//                                                        $cities=\App\Models\City::where('country_name',$name)->pluck('name');
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control address uniqueadd"
                                                                   name="address" id="{{$addid}}"
                                                                   placeholder="Street Address"
                                                                   onkeypress="handleEnterKey(event)"
                                                                   value="{{$loc1->street_add}}"/>
                                                           {{-- <div class="suggesstion-box" hidden="hidden">
                                                                <ul class="country-list suggestionbox_size">
                                                                    <li></li>
                                                                </ul>
                                                            ...
                                                            <input type="hidden" class="long" name="long"
                                                                   value="{{$loc1->long}}">
                                                            <label id="" class="address-error error none-display"
                                                                   for="address"></label>
                                                            <span id="checkaddress-error" style="color: red"></span>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <p style="display: inline;  position: absolute;margin-top: 5px;">
                                                                Ext.</p>
                                                            <input type="tel" name="mobile_number1"
                                                                   class="form-control phone1 mobile_number1 inter_tel"
                                                                   placeholder="(Optional)" id="{{$intelid}}"
                                                                   value="{{$loc1->mobile1}}" disabled="disabled">
                                                            <label id="mobile_number-error" class="error num_er"
                                                                   for="mobile_number" hidden="hidden"></label>
                                                            {{--<input type="text" pattern="[1-9]{1}[0-9]{9}" name="mobile1" class="form-control phone1" placeholder="(Optional)">--}}
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <input type="email" class="form-control email" name="email"
                                                                   placeholder="Email" value="{{$loc1->email}}"/>
                                                        </div>
                                                        {{--                                                        <div class="form-group">--}}
                                                        {{--                                                            <input type="text" class="form-control sms" name="sms"--}}
                                                        {{--                                                                   placeholder="SMS Verification"--}}
                                                        {{--                                                                   value="{{$loc1->sms_verification}}"/>--}}
                                                        {{--                                                        </div>--}}
                                                        {{--<input type="submit" style="display: none;">--}}
                                                    </form>
                                                </div>
                                            ...
                                            <div class="add-div add-package col-lg-8">
                                                <div class="request-i"><a href="javascript:void(0)"
                                                                          class="text-center package-button"
                                                                          style="color: black;background-color: white;"><i
                                                            class="fa fa-plus faplus" aria-hidden="true"></i> Add
                                                        Package</a></div>
                                            </div>
                                ...
                                <div class="col-sm add-loc">
                                    <div class="row">
                                        <div class="add-div col-lg-8">
                                            <div class="request-i"><a href="javascript:void(0)"
                                                                      class="text-center index-button" id="add-loc"
                                                                      style="color: black;background-color: white;"><i
                                                        class="fa fa-plus faplus" aria-hidden="true"></i> Add New
                                                    Location</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style="display: flex;justify-content: center;">
                                <div class="mobile-center col-lg-2 col-md-2 col-sm-2 col-xs-2 index-rem">
                                    <a href="javascript:void(0)" class="form-control index-footer set-right text-center"
                                       id="next-button">Next <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </section>
...
{{--    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCP3oEgZ0L_dSOno0UVkci2sPllCC9gzX4&amp;libraries=places"></script>--}}
    ...
    <script>
        ...
        var formcnt = "{{$formcnt}}";
        var cnt_ext = "{{$cnt_ext}}";
        var cnt_autoadd = "{{$cnt_autoadd}}";
        var packagecnt = "{{$pkgcount}}";
        ...
        $(".col-sm").droppable({
            ...
            drop: function (event, ui) {
                ...
                console.log("droppable", event.target);
...
@foreach($country as $cnt)
             ...
             <div class="form-group">
                <select name="province" id="province" class="form-control">
                    <option value="" selected style="color: #6C757D">Province/Territory/State</option>
                </select>
            </div>
            <div class="form-group">
...
{{--                                                        <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 set-right">Photo</label>--}}
        ...
        function block_ui() {
            $.blockUI({
                message: '<img src="{{url('public/images/loader.gif')}}" />',
                css: {
                    border: 'none',
        ...
        function assign_package() {
            ...
            if (pkgchk == "Package 1") {
                ...
                var html = `<div class="index-div col-lg-8 packagediv signchange">
                <div class="request-i"><a href="javascript:void(0)" class="text-center package-button package"><i class="fa fa-plus faplus fapackage-add" aria-hidden="true"></i><?php echo $pkg->packagecnt ?> <i class="fa fa-close package-close"  aria-hidden="true"></i></a></div>
            </div>
            <div class="form frompackage package-data" style="display: none;margin-right: 10px;">
                <div class="heading">
                <h4 style="color: black;text-align: center">Package Details</h4>
            ...
            <form method="post" role="form" class="package_form" enctype="multipart/form-data">
                ...
                <input type="text" name="weight" class="form-control allow_decimal" id="weight" style="border-top-right-radius: unset;border-bottom-right-radius: unset;" placeholder="Weight" value="{{$pkg->weight}}"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 mobile-set">
                <?php $packagekg = \App\Enums\Packagekg::asArray();?>
...
@foreach($packagekg as $key=>$value)
            ...
            @endforeach
                ...
                <div class="form-group">
                    <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 mobile-set">
                <input type="text" name="dimesionl" class="form-control package-control package-weight allow_decimal" id="dimesionl" placeholder="L" value="{{$pkg->dimesionl}}"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 mobile-set">
                <input type="text" name="dimesionw" class="form-control package-control package-weight allow_decimal" id="dimesionw" placeholder="W" value="{{$pkg->dimesionw}}"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 mobile-set">
                <input type="text" name="dimesionh" class="form-control package-control package-weight allow_decimal" id="dimesionh" placeholder="H" value="{{$pkg->dimesionh}}"/>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 mobile-set">
                <?php $dimension = \App\Enums\Dimensions::asArray();?>
                <select class="form-control package-control package-weight" name="dimensions">
...
@else
                <img class="package-img" src="{{$pkg->Path}}"/>
                    <input type="hidden" value="{{$pkg->image}}" name="hiddenimg">
                ...
                var data = "{{ (preg_replace('/(\v|\s)+/', ' ', $pkg->place))}}";
                $('.packageloc').each(function () {
