                ...
                <div class="modal-content container">
                    ...
                    <div class="modal-body">
                        <div class="form" id="user-form">
                            <form method="post" role="form" name="displayplan" action="{{url('/displayplan1')}}" class="approval-form">
                                {{csrf_field()}}
                                        ...
                                        <div class="row set-center">
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <div style="background-color: #FFC56C;color: white;border-radius: 5px;">
                                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 request-p"><input type='radio' name="plan_radio" value="{{$d->id}}"/></div>
