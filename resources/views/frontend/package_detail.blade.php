                ...
                $.ajax({
                    ...
                    success:function(res){
                        if(res.success==true){
                            ...
                            else if(cnt == 0){ //if cnt=0 that means all packages are store nd redirect it to home page
                               @php
                                $message= 'Delivery Request Sent Successfully .';
                                \Illuminate\Support\Facades\Session::forget('flashmsg');
                                \Illuminate\Support\Facades\Session::put('flashmsg',$message);
                                @endphp
