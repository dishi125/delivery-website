                                            ...
                                            <div class="form">
                                                ...
                                                <form method="post" role="form" id="MyformFrom" action=""
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="name1" class="form-control " id="name1" placeholder="Your Name" value="{{$fromdata->fname}} {{$fromdata->lname}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="company1" class="form-control " id="company1" placeholder="Company Name"/>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 padding-0">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="button" name="sendotp" class="btn send-otp"
                                                                   value="Send OTP"
                                                                   style="background-color: #FFC56C;color: white;width: 100%  " disabled/>
...
{{--    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCP3oEgZ0L_dSOno0UVkci2sPllCC9gzX4&amp;libraries=places"></script>--}}
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyDk8xJ1I8BiADJ_XWxgNVRuPMdR1GnLMbo"></script>
