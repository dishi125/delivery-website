...
@section('content')
    ...
    <div class="container">
        <div class="mobile-center col-lg-2 col-md-2 col-sm-2 col-xs-2" style="display: table;margin: 0 auto">
            <a href="{{url('/newgmapsdata')}}" class="form-control index-footer set-right text-center" id="next-button">Next <i class="fa fa-arrow-right"></i></a>
        </div>
        <div class="mobile-center col-lg-2 col-md-2 col-sm-2 col-xs-2" style="display: table;margin: 0 auto">
            <a href="{{url('/editrequest/'.$pid)}}" class="form-control index-footer set-right text-center" id="edit-button">Edit</a>
        </div>
    </div>
@endsection
