...
@section('content')
    ...
    {{--    </div>--}}
    <div class="mobile-center col-lg-2 col-md-2 col-sm-2 col-xs-2" style="display: table;margin: 0 auto;">
        <a class="form-control index-footer set-right text-center modaldata" data-target=".bs-example-modal-lg" data-toggle="modal">Send Request</a>
    </div>
    <div class="mobile-center col-lg-2 col-md-2 col-sm-2 col-xs-2" style="display: table;margin: 0 auto">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  id="submitplan" class="btn submitplan" data-id="save" style="background-color: #FFC56C;color: white;">Yes</button>
                    <button type="button" class="btn" data-dismiss="modal" style="background-color: #FFC56C;color: white;">No</button>
                    ...
                    success: function (res) {
                        ...
                        if (res.success == false) {
                            setTimeout(function() {
                                window.swal({
                                    title: "Failed!",
                                    text: "Request Not Submitted.Try Again!!!",
                                    type: "error",
                                    showConfirmButton: true,
                                    timer: 5000
                                });
