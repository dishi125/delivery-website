...
@section('main_script')
    ...
    {{--    <script src="https://maps.googleapis.com/maps/api/directions/json?key=AIzaSyBC1-YBl1K4ex8V4j14XK-G5wMHOlypJGs"></script>--}}
            ...
            $.each(locations, function (index, value) {
                ...
                $.each(alldata, function (index1, value1) {
                    if (value.id == value1.location_id) {
                        ...
                        var data1 = new Array();
                        var html=`<p style="height: 15px;width: 15px;background-color:`+value1.color+`"></p>`;
                        ...
                        success: function (res) {
                            if (res.success == true) {
                                ...
                                setTimeout(function() {
                                    window.swal({
                                        title: "Finished!",
                                        text: "Your Plan Saved Successfully.",
                                        type: "success",
                                        showConfirmButton: true,
                                        timer: 5000
                                    }, function () {
                                        window.location = "{{url('/store_main_data')}}";
                                    });
                                },1000);
