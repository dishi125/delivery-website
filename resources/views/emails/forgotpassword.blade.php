                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="padding:0">
                                                <td align="left" style="border-collapse:collapse;padding:0">
                                                    <div>
                                                        <div
                                                            style="color:black;line-height:30px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:24px;font-weight:bold"></div>
                                                    </div>
                                                    <br>
                                                    <div>
                                                        <div
                                                            style="color:black;line-height:20px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px">
                                                            <p>Dear <a >{{ $details['fname'] ." " . $details['lname']}}</a>,
                                                            </p>
                                                            <p><br></p>
